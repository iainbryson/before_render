...
module Rails5BeforeRender
  module BeforeRender
    ...
    module ClassMethods
      ...
      alias append_before_render append_before_render_filter
      alias prepend_before_render prepend_before_render_filter
      alias skip_before_render skip_before_render_filter
    end
  end
end
